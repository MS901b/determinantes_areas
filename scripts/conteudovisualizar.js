	var codigo_do_software = "Det01";
	var nome_do_software = "Determinantes e Áreas";
	...
	var FichaTecnica = $H({
		...
		sinopse: {
			titulo: 'Sinopse',
			conteudo: 'Este software permite aos alunos interpretarem geometricamente o conceito de determinantes de matrizes 2×2, aproximando-se da deﬁnição de determinantes de matrizes como forma de medir volumes de paralelepípedos.'
		},
		conteudos: {
			titulo: 'Conteúdo',
			conteudo: 'Matrizes, determinantes; Geometria Plana, áreas.'
		},
		objetivos: {
			titulo: 'Objetivos',
			conteudo: 'Veriﬁcar a relação entre áreas e determinantes; Investigar como as operações elementares com linhas de matrizes afetam a área de paralelogramos representados por estas matrizes.'
		},
		duracao: {
			titulo: 'Duração',
